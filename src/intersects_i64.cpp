...
template bool intersects(point<std::int64_t> const&, geometry<std::int64_t> const&);
// line_sting
...
template bool intersects(line_string<std::int64_t> const&, geometry<std::int64_t> const&);
// polygon
...
template bool intersects(polygon<std::int64_t> const&, geometry<std::int64_t> const&);
// multi_point
template bool intersects(multi_point<std::int64_t> const&, point<std::int64_t> const&);
template bool intersects(multi_point<std::int64_t> const&, line_string<std::int64_t> const&);
template bool intersects(multi_point<std::int64_t> const&, polygon<std::int64_t> const&);
template bool intersects(multi_point<std::int64_t> const&, multi_point<std::int64_t> const&);
template bool intersects(multi_point<std::int64_t> const&, geometry<std::int64_t> const&);
// geometry
template bool intersects(geometry<std::int64_t>const&, point<std::int64_t> const&);
template bool intersects(geometry<std::int64_t>const&, line_string<std::int64_t> const&);
template bool intersects(geometry<std::int64_t>const&, polygon<std::int64_t> const&);
template bool intersects(geometry<std::int64_t>const&, multi_point<std::int64_t> const&);
